...
The project builds on our previous robot safety implementation using **state machines** and **behaviour trees**. The main goal is to make the software more reliable by adding automated tests, continuous integration, and code quality checks.

The robot safety logic focuses on two important situations:
